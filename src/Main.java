...
public class Main {
    public static void main(String[] args) {
        ...
        while(strength <= 0 || strength >= 1500) {
        ...
        while(!a.equals("stop")){
            ...
            switch (a) {
                ...
                case "phrase":
                    ...
                    System.out.println(myGameUnit.getPhrase());
                    break;
                case "attack":
                    System.out.println("Кого?");
                    int en = in.nextInt();
                    ...
                    switch (en) {
                        case 1:
                            ...
                            System.out.println();
                            System.out.println("Сейчас будет ответочка!");
                            System.out.println();
